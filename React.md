...
[原文地址](https://blog.csdn.net/weiwenjuan0923/article/details/52689365)

封装：封装就是要把属于同一类事物的共性(包括属性与行为)归到一个类中
